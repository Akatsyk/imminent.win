...
public:
	typedef struct _GLOBAL {
		...
		int Last_Server_OutSequenceNrSent, Last_OutSequenceNrSent;
		int Last_Server_ChokeCountSent, Last_Server_InSequenceNrSent;
		int Last_Packet_Size, Last_InSequenceNrSent, Last_ChokeCountSent;

		bool bInActualPrediction;
	...
	config_option(FloatColor, ascent, FloatColor(0.6235294342041016f, 0.7921568751335144f, 0.16470588743686676f, 1.0f));
	config_keybind(key);
	group_end();
...
#pragma region Rage general group
	...
	config_option(bool, run_hitchance, false);
	...
	config_option(bool, accuracy_boost, false);
	config_option(float, accuracy_boost_amount, 0.0f);
...
#pragma region ESP group
	...
	config_option(FloatColor, enemy_chams_color_vis, FloatColor(0.54f, 0.71f, 0.21f, 1.0f));
	config_option(FloatColor, team_chams_color_vis, FloatColor(1.0f, 1.0f, 1.0f, 1.0f));
	config_option(FloatColor, enemy_chams_color_xqz, FloatColor(0.20f, 0.41f, 0.63f, 0.75f));
	...
	config_option(FloatColor, chams_history_color, FloatColor(0.0f, 0.0f, 0.0f, 0.5f));
	...
	config_option(FloatColor, glow_enemy_color, FloatColor(0.62f, 0.2f, 0.4f, 0.6f));
	...
	config_option(bool, indicators, false);
