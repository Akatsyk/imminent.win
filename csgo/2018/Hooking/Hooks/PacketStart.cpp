...
// TODO; rework the servers networking inside of these functions; done properly in mutiny v4.
...
void __fastcall Hooked::PacketEnd( void* ecx, void* ) {
	...
	// bMessageHandlerHooked = false; // possibly uncomment this as possibly message handler may no longer be hooked after the original packet end has been called.
}
